...
$idEntrada = $resultadoBusca['AtIEnId'];

//var_dump($resultadoBusca);die;
				...
				<div class="row">
					...
					<div class="col-lg-12">
						...
						<div class="card">
							<div class="card-header header-elements-inline">
								<div class="col-lg-11">	
                                    <button type="button" class="btn-grid btn btn-md btn-outline-secondary mr-2 active" style="margin-left: -10px;" >Entrada do Paciente</button>
									<button type="button" class="btn-grid btn btn-md btn-outline-secondary mr-2 itemLink " data-tipo='internacaoHospitalarPrescricaoMedica' >Prescrição Médica</button>
									<button type="button" class="btn-grid btn btn-md btn-outline-secondary mr-2 itemLink " data-tipo='internacaoHospitalarEvolucaoMedica' >Evolução Médica</button>
									<button type="button" class="btn-grid btn btn-md btn-outline-secondary mr-2 itemLink " data-tipo='internacaoHospitalarSolicitacaoInterconsulta' >Solicitação Interconsulta</button>
									<button type="button" class="btn-grid btn btn-md btn-outline-secondary mr-2 itemLink " data-tipo='evolucaoEnfermagem' >Evolução Enfermagem</button>
								</div>
							</div>							
						</div>
						...
						<div class="box-entradaPaciente" style="display: block;">
							...
							<div class="card-header header-elements-inline">
									<h3 class="card-title">HISTÓRIA DE ENTRADA</h3>
								</div>
								...
								<div class="card-body">
									...
									<form id="formDieta" name="formDieta" method="post" class="form-validate-jquery">
										...
										<div class="col-lg-12 row mt-2" >
											<div class="col-lg-6">
												<div class="form-group">
													...
													<textarea rows="5" cols="5" maxLength="500" id="historiaEntrada" name="historiaEntrada"  class="form-control" placeholder="..." <?php if (isset($idEntrada )) echo $resultadoBusca['AtIEnDigitacaoLivre'] == '' ? '' : 'readOnly'; ?> ><?php if (isset($idEntrada )) echo $resultadoBusca['AtIEnHistoriaMolestiaAtual']; ?></textarea>
											...
											<div class="col-lg-6">
												<div class="form-group">
													...
													<textarea rows="5" cols="5" maxLength="500" id="exameFisico" name="exameFisico"  class="form-control" placeholder="..." <?php if (isset($idEntrada )) echo $resultadoBusca['AtIEnDigitacaoLivre'] == '' ? '' : 'readOnly'; ?> ><?php if (isset($idEntrada )) echo $resultadoBusca['AtlEnExameFisico']; ?></textarea>
													<small class="text-muted form-text">Max. 500 caracteres - <span class="caracteresjustificativa"></span></small>
												</div>
											</div>
											...
											<div class="col-lg-6">
												<div class="form-group">
													...
													<textarea rows="5" cols="5" maxLength="500" id="hipoteseDiagnostica" name="hipoteseDiagnostica"  class="form-control" placeholder="..." <?php if (isset($idEntrada )) echo $resultadoBusca['AtIEnDigitacaoLivre'] == '' ? '' : 'readOnly'; ?> ><?php if (isset($idEntrada )) echo $resultadoBusca['AtIEnHipoteseDiagnostica']; ?></textarea>
													<small class="text-muted form-text">Max. 500 caracteres - <span class="caracteresjustificativa"></span></small>
												</div>
											</div>
											...
											<div class="col-lg-6">
												<div class="form-group">
													<label for="justificativa">ANAMNESE MÉDICA (DIGITAÇÃO LIVRE)</label>
													<textarea rows="5" cols="5" maxLength="1000" id="anamnese" name="anamnese"  class="form-control" placeholder="..." ><?php if (isset($idEntrada )) echo $resultadoBusca['AtIEnDigitacaoLivre']; ?></textarea>
										...
										<div class="col-lg- row mt-2 ml-1">

											<div class="col-lg-4">
												<div class="form-group">
													
													<label for="justificativa">CARÁTER DA INTERNAÇÃO </label>
													<?php echo $iAtendimentoId; ?>
													...
													<select id="caraterInternacao" name="caraterInteraacao" class="select-search" >
														...
														<?php
															...
															foreach($result as $item){
																...
																if ( isset( $idEntrada ) && $resultadoBusca['AtIEnCaraterInternacao'] == $item['CrIntId'] ) {
								...
								<div class="card-header header-elements-inline">
									<h3 class="card-title">JUSTIFICATIVA DA INTERNAÇÃO ( AIH / TISS )</h3>
								</div>
										...
										<div class="row" style="margin-top: 10px">
											<div class="col-lg-12">
												<div class="form-group">
													...
													<textarea rows="5" cols="5" maxLength="470" id="sinaisESintomasClinicos" name="sinaisESintomasClinicos" onInput="contarCaracteres(this);" class="form-control" placeholder="Informe o texto dos Sinais e Sintomas." ><?php if (isset($idEntrada )) echo $resultadoBusca['AtIEnPrincipaisSinais']; ?></textarea>
										...
										<div class="row" style="margin-top: 10px">
											<div class="col-lg-12">
												<div class="form-group">
													...
													<textarea rows="4" cols="4" maxLength="350" id="justificativaInternacao" name="justificativaInternacao" onInput="contarCaracteres(this);" class="form-control" placeholder="Informe o texto da Justificativa de Internação." ><?php if (isset($idEntrada )) echo $resultadoBusca['AtIEnJustificativa']; ?></textarea>
										...
										<div class="row" style="margin-top: 10px">
											<div class="col-lg-12">
												<div class="form-group">
													...
													<textarea rows="4" cols="4" maxLength="350" id="resultProvaDiagnostica" name="resultProvaDiagnostica" onInput="contarCaracteres(this);" class="form-control" placeholder="Informe o texto do Resultado da Prova Diagnóstica." ><?php if (isset($idEntrada )) echo $resultadoBusca['AtIEnPrincipaisResultados']; ?></textarea>
													<small class="text-muted form-text">Max. 350 caracteres - <span class="caracteresjustificativa"></span></small>
												</div>
											</div>
										</div>
											...
											<div class="col-lg-6">
												<select id="cid10" name="cid10" class="select-search">
													...
													<?php
														...
														FROM Cid10";
														$result = $conn->query($sql);
														$resultCid10 = $result->fetchAll(PDO::FETCH_ASSOC);

														//var_dump($resultadoBusca['AtIEnCid10']);die;

														foreach($resultCid10 as $item){
															
															if ( isset( $idEntrada ) && $resultadoBusca['AtIEnCid10'] == $item['Cid10Id'] ) {
																echo "<option value='$item[Cid10Id]' selected>$item[Cid10Codigo] - $item[Cid10Descricao]</option>";                                        
															} else {
																echo "<option value='$item[Cid10Id]'>$item[Cid10Codigo] - $item[Cid10Descricao]</option>";
															}	
											...
											<div class="col-lg-6">
												<select id="servico" name="servico" class="select-search">
													...
													<?php
														...
														$result = $conn->query($sql);
														$resultProcedimento = $result->fetchAll(PDO::FETCH_ASSOC);

														foreach($resultProcedimento as $item){
															
															if ( isset( $idEntrada ) && $resultadoBusca['AtIEnProcedimento'] == $item['SrVenId'] ) {
																echo "<option value='$item[SrVenId]' selected>$item[SrVenCodigo] - $item[SrVenNome]</option>";                                        
															} else {
																echo "<option value='$item[SrVenId]'>$item[SrVenCodigo] - $item[SrVenNome]</option>";
															}	
