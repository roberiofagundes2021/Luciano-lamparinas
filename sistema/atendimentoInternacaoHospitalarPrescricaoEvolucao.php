						...
						<div class="card">
							<div class="card-header header-elements-inline">
								<div class="col-lg-11">	
									...
									<button type="button" class=" btn btn-md btn-outline-secondary mr-2 active " >Prescrição Médica</button>
									<button type="button" class=" btn btn-md btn-outline-secondary mr-2 itemLink " data-tipo='internacaoHospitalarEvolucaoMedica' >Evolução Médica</button>
